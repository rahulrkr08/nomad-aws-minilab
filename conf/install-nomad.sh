...
sudo curl https://raw.githubusercontent.com/rahulrkr08/nomad-aws-minilab/master/conf/nomad/server.hcl -o /tmp/nomad/server.hcl
...
sudo curl https://raw.githubusercontent.com/rahulrkr08/nomad-aws-minilab/master/conf/consul/server.hcl -o /tmp/consul/server.hcl
